...
if result_order and result_order.retcode == 10027:
    warn("Autotrading disabilitato (10027) — invio Ctrl+E alla finestra MT5...")
...
"""
    ...
    # Diagnostica stato dopo Ctrl+E
    tinfo2 = mt5.terminal_info()
    acc2   = mt5.account_info()
    sym2   = mt5.symbol_info(ORDER_SYMBOL)
    info(f"terminal_info().trade_allowed  = {tinfo2.trade_allowed if tinfo2 else '?'}")
